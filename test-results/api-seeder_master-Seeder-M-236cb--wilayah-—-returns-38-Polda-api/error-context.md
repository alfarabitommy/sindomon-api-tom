...
- Name: api/seeder_master.spec.ts >> Seeder Master Data >> GET /api/v1/master/wilayah — returns 38 Polda
- Location: tests/api/seeder_master.spec.ts:45:7
...
Expected length: 2
Received length: 3
Received array:  [{"is_active": "1", "nama_polres": "Polrestabes 1.1", "polda_id": "1", "polres_id": "1", "updated_at": null}, {"is_active": "1", "nama_polres": "Polres 1.2", "polda_id": "1", "polres_id": "2", "updated_at": null}, {"is_active": "1", "nama_polres": "Polres Test Sukses", "polda_id": "1", "polres_id": "77", "updated_at": null}]
```
...
```ts
  ...
  9   |   expect(body, `${path}: missing 'data'`).toHaveProperty('data');
  10  | }
  11  | 
